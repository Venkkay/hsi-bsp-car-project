 ...
 * \param   current_position_light_state : Current status of position lights
 * \param   cmd_value : Value sent by the comodo for position lights
 * \param   start_timer : Time from which the FSM is requested
 ...
 * \param   current_low_beam_state : Current status of low beams lights
